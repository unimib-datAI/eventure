...
const SuggestionDestination = ({ title, caption,label,labelImage,  image }: SuggestionDestination) => {
...
">
        <View className="flex flex-row items-center justify-start ">
          <Image
            source={image}
            className="mr-4 h-[73px] w-[73px] rounded-[10px]"
            resizeMode="cover"
          />
...
export default SuggestionDestination;
