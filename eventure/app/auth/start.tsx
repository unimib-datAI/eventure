...
const Start = () => {
  ...
  return (
    <View className="flex-1 bg-white px-4  items-center justify-center">
      ...
      <Text className="text-base text-[#120D26] font-regular text-center mt-6 w-[80%]">
        Scopri la tua città come mai prima d'ora: cammina, accumula punti e
        trasforma il tuo percorso in un'esperienza unica per migliorare il
        flusso urbano
      </Text>
      <TouchableOpacity
